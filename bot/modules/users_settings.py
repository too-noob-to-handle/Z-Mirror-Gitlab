...
Examples:
1. <code>{escape('<b>Join: @BangladeshHoarding</b>')}</code> 
This will give output as:
<b>Join: @BangladeshHoarding</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @BangladeshHoarding</code>')}</code> 
This will give output as:
<code>Join: @BangladeshHoarding</code> <code>69MB.bin</code>.
